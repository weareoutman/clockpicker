...
;(function($){
	...
	function ClockPicker(element, options) {
		...
		if (options.twelvehour) {
			...
			$('<button type="button" class="btn btn-sm btn-outline-secondary clockpicker-button am-button">' + "AM" + '</button>')
				.on("click", function() {
					self.amOrPm = "AM";
			...
			$('<button type="button" class="btn btn-sm btn-outline-secondary clockpicker-button pm-button">' + "PM" + '</button>')
				.on("click", function() {
					self.amOrPm = 'PM';
		...
		if (! options.autoclose) {
			...
			$('<button type="button" class="btn btn-sm btn-outline-primary btn-block clockpicker-button">' + options.donetext + '</button>')
